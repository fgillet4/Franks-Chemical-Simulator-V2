...
fig.suptitle("""LEP-12-1b: Butane Isomerization (Counter-Current)""", fontweight='bold', x = 0.18,y=0.97)
...
ax1.text(-10, 120,'Instructions'
         '\n \n'
         'Guess a value of $T_a$ at V=0 and see if it matches $T_a$=315 K at V=5 ${m^3}$'
         '\n'
        'So, Whenever you change any parameter,you also need to vary $T_{a0}$ to match '
        '\n'
        '$T_a$=315 K at V=5 ${m^3}$', ha='left', wrap = True, fontsize=12,
...
ax_Ta0 = plt.axes([0.24, 0.54, 0.1, 0.015], facecolor=axcolor)
...
sTa0= Slider(ax_Ta0, '$T_{ao}$ (K)', 273, 500, valinit=340.3,valfmt='%1.1f')
