...
fig.suptitle("""LEP-12-1d: Butane Isomerization (Adiabatic Operation)""", fontweight='bold', x = 0.18,y=0.97)
...
axcolor = 'black'
ax_Ca0 = plt.axes([0.24, 0.74, 0.1, 0.015], facecolor=axcolor)
ax_dH = plt.axes([0.24, 0.70, 0.1, 0.015], facecolor=axcolor)
...
resetax = plt.axes([0.24, 0.8, 0.09, 0.04])
