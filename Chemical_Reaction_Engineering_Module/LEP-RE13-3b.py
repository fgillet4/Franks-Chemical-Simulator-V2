...
fig.suptitle("""PRS Example CD13-3b Proportion-Integral Control of a CSTR""", fontweight='bold', x = 0.45, y=0.98)
...
ax1.text(-1.05, -1.55,'Differential Equations'
         ...
         '\n\n'     
          r'$m_C = m_{C0} + k_C(T - T_{SP}) + \dfrac{k_C.I}{\tau}$'   
         '\n\n'     
...
resetax = plt.axes([0.37, 0.85, 0.09, 0.03])
