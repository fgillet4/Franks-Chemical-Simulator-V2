...
fig.suptitle("""LEP-12-7d:Complex Reactions with Heat Effects in a PFR (Adiabatic)""", fontweight='bold', x = 0.5,y=0.97)
...
ax1.text(-1.05, -1.28,'Differential Equations'
        ...
        , ha='left', wrap = True, fontsize=10.0,
...
ax_DH1b = plt.axes([0.32, 0.73, 0.2, 0.015], facecolor=axcolor)
ax_DH2a = plt.axes([0.32, 0.70, 0.2, 0.015], facecolor=axcolor)
ax_Cpa = plt.axes([0.32, 0.67, 0.2, 0.015], facecolor=axcolor)
ax_Cpb = plt.axes([0.32, 0.64, 0.2, 0.015], facecolor=axcolor)
ax_Cpc = plt.axes([0.32, 0.61, 0.2, 0.015], facecolor=axcolor)
ax_Cpd = plt.axes([0.32, 0.58, 0.2, 0.015], facecolor=axcolor)
...
sDH2a = Slider(ax_DH2a, r'$\Delta H_{Rx2A}$ ($\frac{cal}{mol A}$)', -5000000, -20, valinit=-10000,valfmt='%1.0f')
...
resetax = plt.axes([0.36, 0.86, 0.09, 0.05])
